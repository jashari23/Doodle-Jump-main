...
public class DoodleJump_newbackground extends JFrame implements MouseListener, KeyListener {
    ...
    public DoodleJump_newbackground() {
    ...
    public class DrawPanel extends JPanel {
        ...
        public void background2(Graphics g) {
            g.drawImage(Assets.background2, 0, 0, D_W, D_H, null);
        }
        ...
        public void drawValues(Graphics g) {
            ...
            if (keycode == KeyEvent.VK_RIGHT) {
                g.drawImage(Assets.playerRight2, x - 45, y - 100, null);
