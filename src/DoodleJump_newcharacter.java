...
public class DoodleJump_newcharacter extends JFrame implements MouseListener, KeyListener {
    ...
    public DoodleJump_newcharacter() {
    ...
    public class DrawPanel extends JPanel {
        ...
        public void drawValues(Graphics g) {
            ...
            if (keycode == KeyEvent.VK_RIGHT) {
                ...
                g.drawImage(Assets.playerLeft2, x - 45, y - 100, null);
            } else {
                g.drawImage(Assets.playerLeft2, x - 45, y - 100, null);
            }
